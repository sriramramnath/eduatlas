...
- Compare to living sample/calculate age (1)
...
- Current decreases and alarm sounds (1)
...
a) Explain why technetium-99m is suitable as a medical tracer for diagnosis. Include reference to:
   ...
   - Its half-life
   - Why these properties are important (4 marks)

b) Compare the properties required for an isotope used in:
   - External radiotherapy
   - Internal radiotherapy (brachytherapy)
   Give reasons for the differences. (4 marks)
...
**Part a) (4 marks):***
- Gamma emitter (1)
- Can be detected outside body/penetrates tissue (1)
- Short half-life of 6 hours (1)
- Minimizes radiation dose to patient/decays quickly (1)

**Part b) (4 marks):***
- External: high-energy gamma (penetrates to deep tumors) (2)
- Internal: beta or low-energy gamma (short range, targets specific area) (2)

**Part c) (2 marks):***
- 24 hours = 4 half-lives (1)
- Activity = 200 × (½)⁴ = 200/16 = 12.5 MBq (1)
...
- [ ] Understand radiotherapy principles
- [ ] Can explain carbon dating calculations
- [ ] Know industrial applications
- [ ] Understand smoke detector operation
- [ ] Know safety principles (ALARA)
- [ ] Can calculate ages using half-life
