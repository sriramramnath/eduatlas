...
### Question 3
In the UK, the frequency of mains electricity is:
...
### Question 6
A device draws 5 A from a 230 V supply. What is its power?
...
B) To protect the circuit by melting if current is too high  
C) To store charge  
...
### Question 8
Which wire in a three-pin plug is connected to the metal casing of an appliance for safety?
...
### Question 9
A 2 kW heater is used for 3 hours. How much energy is used in kWh?
...
### Question 11
A kettle draws 8 A from the mains. What rating fuse should be used?
...
A) It is cheaper  
B) It can be reset after tripping  
C) It allows higher currents  
D) It does not need a switch
...
### Statement 2
In a metal, electric current is carried by positive charges.

**Answer: False***

**Correction**: In metals, current is carried by electrons, which are negatively charged.*
...
**Correction**: Alternating current (AC) periodically changes direction. Direct current (DC) flows in one direction only.*

---

### Statement 4
The neutral wire in a mains circuit is at approximately 0 V.
...
### Statement 5
A 3 A fuse should be used for an appliance that normally draws 4 A.

**Answer: False***

**Correction**: A 3 A fuse would blow during normal operation. A 5 A or 13 A fuse should be used (next standard rating above 4 A).*
...
### Statement 7
The unit of electrical energy used on electricity bills is the joule.

**Answer: False***

**Correction**: Electricity bills use kilowatt-hours (kWh), not joules. 1 kWh = 3.6 million joules.*
...
### Statement 9
An RCD (Residual Current Device) protects against current overload.

**Answer: False***

**Correction**: An RCD detects current leakage to earth. Fuses and circuit breakers protect against current overload.*

---

### Statement 10
At 50 Hz, the direction of AC current changes 100 times per second.
...
### Statement 11
The earth wire carries current during normal operation.

**Answer: False***

**Correction**: The earth wire only carries current if there is a fault. During normal operation, it carries no current.*
...
- This would be dangerous as appliance remains live (1 mark)

---

### Question 6 (3 marks)
A 2.5 kW kettle operates from the 230 V mains. Calculate:
...
- Circuit is broken, preventing shock (1 mark)
...
- Any two from:
  ...
  - More sensitive/provide better protection (1 mark)
  - Can detect different types of fault (1 mark)

---

### Question 10 (4 marks)
A 60 W lamp is used for 5 hours.
...
- Prevents person touching casing from receiving electric shock (1 mark)
(Any 2 points)
