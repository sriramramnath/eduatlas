...
B) Gas particles colliding with container walls  
C) Gravity pulling particles down  
D) Gas particles sticking to walls
...
### Question 4
A gas at 200,000 Pa occupies 3 m³. What is the pressure when compressed to 1 m³ at constant temperature?
...
B) Only at the surface of a liquid  
C) Throughout the liquid  
D) Only in solids
...
### Question 8
When a liquid evaporates, its temperature:
...
B) Liquid turns to gas  
C) Gas turns to liquid  
D) Solid turns to gas
...
A) Close together in fixed positions  
B) Close together and moving randomly  
...
### Question 12
If the temperature of a gas increases at constant volume, the pressure:
...
### Statement 1
In a liquid, particles are arranged in a regular pattern.

**Answer: False***

**Correction**: In liquids, particles are close together but not in a regular pattern. They can move past each other.*

---

### Statement 2
Energy is absorbed during freezing.

**Answer: False***

**Correction**: Energy is RELEASED during freezing (liquid to solid). Energy is absorbed during melting.*
...
### Statement 4
Boiling occurs throughout a liquid, not just at the surface.
...
**Correction**: Evaporation causes COOLING of the remaining liquid because the fastest particles escape.*
...
### Statement 7
In a solid, particles have no kinetic energy.

**Answer: False***

**Correction**: Particles in a solid do have kinetic energy - they vibrate about fixed positions. At absolute zero, kinetic energy would be minimal.*
...
**Explanation**: Sublimation is the direct change from solid to gas, skipping the liquid phase (e.g., dry ice). 

---

### Statement 10
The temperature of a substance always increases when heat is added.

**Answer: False***

**Correction**: During a change of state, temperature stays constant even though heat is being added.*

---

### Statement 11
Gas pressure increases with temperature because particles move faster.
...
### Statement 12
In a liquid, particles are far apart with large spaces between them.

**Answer: False***

**Correction**: In liquids, particles are close together (similar to solids). In gases, particles are far apart.*
...
- Temperature of skin decreases (1 mark)
...
- Many collisions per second creates steady pressure (1 mark)
