...
### Question 2
A 20 N force acts 0.4 m from a pivot. What is the moment?
...
### Question 3
According to the principle of moments, for an object in equilibrium:

A) All forces must be equal  
B) Clockwise moments equal anticlockwise moments  
C) All distances must be equal  
D) The pivot must be in the centre
...
### Question 4
A 30 N weight is placed 2 m from a pivot. Where should a 20 N weight be placed to balance it?
...
B) Where the entire weight appears to act  
C) Always at the bottom  
D) Where the mass is greatest
...
### Question 6
Which factor increases the stability of an object?
...
### Question 7
In a Class 2 lever, the arrangement is:
...
A) Two equal forces in the same direction  
B) Two unequal forces in opposite directions  
C) Two equal and opposite parallel forces  
D) Two forces at right angles
...
### Question 11
An object will topple when:

A) Its centre of gravity is above its base  
B) Its centre of gravity is below its base  
C) Its centre of gravity moves outside its base  
D) It has a wide base
...
### Statement 1
The moment of a force depends only on the size of the force.

**Answer: False***

**Correction**: Moment depends on both the force AND the perpendicular distance from the pivot (M = F × d).*
...
### Statement 3
The centre of gravity of a uniform metre rule is at the 50 cm mark.
...
### Statement 4
A wider base always makes an object more stable.
...
### Statement 5
In a Class 3 lever, the effort is always less than the load.

**Answer: False***

**Correction**: In Class 3 levers (e.g., tweezers), the effort is greater than the load, but the load moves further.*
...
### Statement 7
The unit of moment is the newton per metre.

**Answer: False***

**Correction**: The unit of moment is the newton metre (Nm), not newton per metre.*
...
**Correction**: For complete equilibrium, both resultant force AND resultant moment must be zero.*
...
### Statement 11
The perpendicular distance in moment calculations is always the shortest distance from the pivot to the line of action of the force.
...
**Correction**: A wheelbarrow is a Class 2 lever (pivot - load - effort arrangement).*
...
- The intersection of the lines is the centre of gravity (1 mark)
...
- Example: wheelbarrow, nutcracker (1 mark)
...
- Without any net force (no translation) (1 mark)
