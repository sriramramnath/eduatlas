...
### Question 3
A wire has a resistance of 4 Ω. If its length is doubled (same thickness), what is the new resistance?
...
### Question 4
A wire has a resistance of 12 Ω. If its cross-sectional area is doubled (same length), what is the new resistance?
...
### Question 5
Which component does NOT obey Ohm's Law?

A) Copper wire at constant temperature  
B) Fixed resistor  
C) Filament lamp  
D) Nichrome wire at constant temperature
...
A) Has the same resistance in both directions  
B) Only allows current to flow in one direction  
...
### Question 10
A wire has length 2 m, area 1 mm², and resistivity 2 × 10⁻⁸ Ωm. What is its resistance?
...
A) Has very high resistance  
B) Has zero resistance below a critical temperature  
C) Can only conduct AC  
D) Becomes magnetic when current flows
...
### Statement 1
Resistance is defined as voltage divided by current.
...
### Statement 2
All electrical conductors obey Ohm's Law.

**Answer: False***

**Correction**: Only ohmic conductors obey Ohm's Law. Many components (lamps, diodes, thermistors) do not obey Ohm's Law.*
...
**Correction**: Resistance is inversely proportional to cross-sectional area (R ∝ 1/A). Thicker wires have lower resistance.*

---

### Statement 4
A filament lamp has a constant resistance regardless of voltage.

**Answer: False***

**Correction**: A filament lamp's resistance increases as voltage increases (and it gets hotter).*
...
### Statement 6
For a thermistor (NTC), resistance decreases as temperature increases.
...
### Statement 7
If the length of a wire is tripled, its resistance becomes one-third.

**Answer: False***

**Correction**: Resistance is proportional to length. Tripling the length triples the resistance.*

---

### Statement 8
A diode conducts current equally well in both directions.

**Answer: False***

**Correction**: A diode only conducts in one direction (forward bias). In reverse bias, it has very high resistance.*

---

### Statement 9
Copper has a lower resistivity than nichrome.
...
### Statement 10
The V-I graph for an ohmic conductor is a straight line through the origin.
...
**Correction**: Glass is an excellent insulator with very high resistivity (about 10¹² Ωm).*

---

### Statement 12
For metals, resistance decreases as temperature increases.

**Answer: False***

**Correction**: For metals, resistance increases as temperature increases due to increased ion vibrations.*
...
- Plot graph of resistance against length (1 mark)
...
- R = 0.0425 Ω (accept 0.043 Ω) (1 mark)
...
- Any two from:
  ...
  - Material/resistivity (1 mark)

---

### Question 9 (3 marks)
Sketch the V-I characteristic graph for:
...
- Example: filament lamp / diode / thermistor (1 mark)
...
(b) The student connects the wire to a 6.0 V battery. Calculate the current in the wire. (2 marks)
