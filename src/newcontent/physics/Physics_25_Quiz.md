...
### Question 5
Compare nuclear fission and fusion in terms of:
...
b) Explain the function of:
   i) The moderator (2 marks)
   ii) The control rods (2 marks)
...
- Forms two smaller nuclei (1)
- Releases energy and 2-3 neutrons (1)
- Neutrons cause further fission/chain reaction (1)

**Part b) i) (2 marks):***
- Slows down fast neutrons (1)
- Slow neutrons more likely to cause fission (1)

**Part b) ii) (2 marks):***
- Absorb neutrons (1)
- Control rate of reaction/can shut down reactor (1)

**Part c) (6 marks):***

**Fission advantages:***
- Proven technology (1)
- No CO₂ emissions during operation (1)

**Fission disadvantages:***
- Radioactive waste (1)
- Risk of accidents/meltdown (1)

**Fusion advantages:***
- Abundant fuel (hydrogen) (1)
- Less radioactive waste (1)
- Safer (no meltdown risk) (1)

**Fusion disadvantages:***
- Not yet commercially viable (1)
- Requires extreme conditions (1)

(Maximum 6 marks from valid points)

---

## Quick Review Checklist

- [ ] Understand fission process
- [ ] Know reactor components and functions
- [ ] Understand fusion process
- [ ] Know conditions for fusion
- [ ] Can use E = mc²
- [ ] Can compare fission and fusion
