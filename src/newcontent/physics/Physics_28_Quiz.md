...
- Therefore galaxies moving away/universe expanding (1)
...
- Predicted by Big Bang theory/exists as expected (1)
...
b) Explain how Hubble's observations led to the development of the Big Bang theory. (4 marks)

c) Describe the Cosmic Microwave Background (CMB) and explain why it is considered strong evidence for the Big Bang. (4 marks)
...
- Moving away: wavelength increased/redshift (1)
- Moving toward: wavelength decreased/blueshift (1)
- Galaxies show redshift/moving away (1)

**Part b) (4 marks):***
- Hubble observed redshift of galaxies (1)
- Found v proportional to d (Hubble's Law) (1)
- Implies universe is expanding (1)
- Suggests universe began from single point/Big Bang (1)

**Part c) (4 marks):***
- CMB is microwave radiation from all directions (1)
- Temperature ~2.7 K (1)
- Formed when universe became transparent (~380,000 years after Big Bang) (1)
- Predicted by Big Bang theory/exactly as expected (1)

**Part d) (4 marks):***
- Dark matter: invisible mass detected by gravitational effects (1)
- Dark matter: holds galaxies together/explains rotation curves (1)
- Dark energy: causes accelerating expansion (1)
- Together they make up ~95% of universe's mass-energy (1)

---

## Quick Review Checklist

- [ ] Know distance units (AU, ly, parsec)
- [ ] Understand Doppler effect
- [ ] Can calculate redshift
- [ ] Know Hubble's Law
- [ ] Understand Big Bang evidence
- [ ] Know CMB properties
- [ ] Understand universe fate scenarios
- [ ] Know galaxy types
