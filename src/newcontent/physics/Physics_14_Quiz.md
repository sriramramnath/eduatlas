...
### Question 3
An object of mass 5 kg is raised to a height of 3 m. What is its gravitational potential energy? (g = 10 N/kg)
...
### Question 4
Which energy transfer occurs when a ball falls?
...
### Question 5
A machine uses 800 J of energy and produces 600 J of useful work. What is its efficiency?
...
### Question 9
A ball is dropped from 20 m. What is its speed just before hitting the ground? (Ignore air resistance, g = 10 N/kg)
...
### Question 11
The efficiency of a machine can never be:
...
### Question 12
Which energy resource produces CO₂ when used?
...
**Correction**: Energy cannot be created OR destroyed, only transferred from one form to another (conservation of energy).*
...
### Statement 3
Renewable energy resources will eventually run out.

**Answer: False***

**Correction**: Renewable resources will NOT run out - they are naturally replenished.*

---

### Statement 4
Gravitational potential energy depends on an object's mass, height, and g.
...
### Statement 5
When a car brakes, kinetic energy is converted to chemical energy.

**Answer: False***

**Correction**: When a car brakes, kinetic energy is mainly converted to thermal energy (heat in the brakes).*
...
**Correction**: Nuclear energy uses uranium, which is a finite resource. It is non-renewable.*

---

### Statement 7
Efficiency is calculated as useful output divided by total input.
...
### Statement 12
The higher an object is above the ground, the less gravitational potential energy it has.

**Answer: False***

**Correction**: GPE = mgh, so higher height means MORE gravitational potential energy.*
...
### Question 3 (4 marks)
A 3 kg ball is dropped from a height of 10 m.
...
- Example: coal, oil, natural gas, nuclear (1 mark)

---

### Question 6 (3 marks)
Describe the energy transfers that occur when:
...
- Any two from:
  ...
  - Wind produces no air pollution (1 mark)
  - No fuel costs (1 mark)
...
### Question 10 (4 marks)
A car of mass 800 kg is travelling at 15 m/s.
...
- In the brakes and tyres / surroundings (1 mark)
